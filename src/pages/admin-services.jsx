...
const generateFakeServices = () => [
  ...
  { id: 2, name: 'طلب شهادة صحية', category: 'الصحة', status: 'نشط', lastUpdated: '12 ديسمبر، 2024' },
  { id: 3, name: 'تسجيل في المدرسة', category: 'التعليم', status: 'غير نشط', lastUpdated: '10 ديسمبر، 2024' },
  { id: 4, name: 'تصريح وقوف السيارات', category: 'النقل', status: 'نشط', lastUpdated: '8 ديسمبر، 2024' },
  { id: 5, name: 'طلب توصيل المياه', category: 'المرافق', status: 'نشط', lastUpdated: '5 ديسمبر، 2024' },
  { id: 6, name: 'طلب رخصة بناء', category: 'التراخيص', status: 'نشط', lastUpdated: '3 ديسمبر، 2024' },
  { id: 7, name: 'استئناف تقييم الضرائب', category: 'المالية', status: 'قيد الانتظار', lastUpdated: '1 ديسمبر، 2024' }
];
                ...
                <Box>
                  ...
                  <Box display="flex" justifyContent="space-between" alignItems="center" mt={2}>
                    <Typography variant="body2">
                      عرض {Math.min((page - 1) * itemsPerPage + 1, filteredServices.length)} -
                      {Math.min(page * itemsPerPage, filteredServices.length)} من {filteredServices.length}
                    </Typography>
